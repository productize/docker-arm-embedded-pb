...
RUN apt-get update -qq && apt-get install -yq protobuf-compiler protobuf-c-compiler python-protobuf python-pip && pip install IntelHex && rm -rf /var/lib/apt/lists/*
